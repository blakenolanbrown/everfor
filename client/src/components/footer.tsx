    ...
    <footer className="bg-deep-charcoal border-t border-gold/20 py-12">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              <button 
                ...
                className="block text-very-light-grey hover:text-gold transition-colors text-left"
              >
                Services
              </button>
              <button 
          ...
          <div>
            ...
            <div className="space-y-2 text-very-light-grey">
              <div className="hover:text-gold transition-colors duration-300">hello@everfor.family</div>
        ...
        <div className="border-t border-gold/20 mt-12 pt-8 text-center">
          <p className="text-very-light-grey hover:text-gold transition-colors duration-300">
